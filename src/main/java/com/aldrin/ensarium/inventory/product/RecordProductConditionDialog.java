...
public final class RecordProductConditionDialog extends JDialog {
    private final JLabel productValue = new JLabel();
    private final JLabel onhandValue = new JLabel();
    private final JLabel actionValue = new JLabel();
    ...
    public RecordProductConditionDialog(java.awt.Window owner, String actionLabel, String productName, BigDecimal onhandQty) {
        super(owner, actionLabel + " Product Qty", Dialog.ModalityType.APPLICATION_MODAL);
        initUi(actionLabel, productName, onhandQty);
    }

    private void initUi(String actionLabel, String productName, BigDecimal onhandQty) {
        ...
        actionValue.setText(actionLabel);
        addValue(form, gbc, actionValue);
