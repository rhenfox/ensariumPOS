 ...
 */
public class ProductInventoryPanel2 extends javax.swing.JPanel {

    /**
     * Creates new form ProductInventoryPanel2
     */
//    public ProductInventoryPanel2() {
//        initComponents();
//    }
...
//    Icon iconPlus = FaSwingIcons.icon(FontAwesomeIcon.PLUS, 24, Color.WHITE);
    Icon iconOrder = new Icons().dolly(18, Color.WHITE);
    Icon iconFileContact= new Icons().fileInvoice(18, Color.WHITE);
    Icon iconFileInvoice= new Icons().fileContract(18, Color.WHITE);
    Icon iconPriceLogs= new Icons().fileContract(18, Color.WHITE);
//    Icon iconPrint = FaSwingIcons.icon(FontAwesomeIcon.PRINT, 24, Color.WHITE);
//    Icon iconPrint1 = FaSwingIcons.icon(FontAwesomeIcon.FILE_TEXT_ALT, 24, Color.WHITE);
    Icon iconTag = FaSwingIcons.icon(FontAwesomeIcon.TAG, 24, Color.WHITE);
    Icon iconDamage = FaSwingIcons.icon(FontAwesomeIcon.CHAIN_BROKEN, 24, Color.BLACK);
    Icon iconExpired = FaSwingIcons.icon(FontAwesomeIcon.CALENDAR, 24, Color.BLACK);
    Icon iconReturn = FaSwingIcons.icon(FontAwesomeIcon.REPLY, 24, Color.BLACK);
    Icon iconShrinkage = FaSwingIcons.icon(FontAwesomeIcon.TRASH, 24, Color.BLACK);

    public ProductInventoryPanel2(Session session, OrderDraftManager draftManager) {
        this.session = session;
        this.draftManager = draftManager;
        initComponents();
        damageButton.setWarning();
        expiredButton.setWarning();
        returnedButton.setWarning();
        shrinkageButton.setWarning();
        stockOnHandReportButton.setSecondary();
        physicalCountReportButton.setSecondary();
        addToOrderButton.setSecondary();
        logsButton.setSecondary();
        
        searchField.putClientProperty("JTextField.placeholderText", "Search...");
        
        refreshButton.setToolTipText("Refresh");
        addToOrderButton.setToolTipText("Add to order");
        stockOnHandReportButton.setToolTipText("Stock onhand report");
        physicalCountReportButton.setToolTipText("Physical count report");
        logsButton.setToolTipText("Price logs");
        damageButton.setToolTipText("Add damaged");
        expiredButton.setToolTipText("Add expired");
        returnedButton.setToolTipText("Returned product");
        shrinkageButton.setToolTipText("Shrinkage product");

        refreshButton.setIcon(iconRefresh);
        addToOrderButton.setIcon(iconOrder);
        stockOnHandReportButton.setIcon(iconFileContact);
        physicalCountReportButton.setIcon(iconFileInvoice);
        logsButton.setIcon(iconTag);
        damageButton.setIcon(iconDamage);
        expiredButton.setIcon(iconExpired);
        returnedButton.setIcon(iconReturn);
        shrinkageButton.setIcon(iconShrinkage);
        ...
        int[] widths = {55, 0, 110, 300, 135, 80, 110, 150, 110, 110, 195, 195, 210, 210, 240, 150};
...
//        loadInventory();
    ...
    private void initComponents() {
        ...
        refreshButton = new com.aldrin.ensarium.ui.widgets.StyledButton();
        addToOrderButton = new com.aldrin.ensarium.ui.widgets.StyledButton();
        stockOnHandReportButton = new com.aldrin.ensarium.ui.widgets.StyledButton();
        physicalCountReportButton = new com.aldrin.ensarium.ui.widgets.StyledButton();
        logsButton = new com.aldrin.ensarium.ui.widgets.StyledButton();
        damageButton = new com.aldrin.ensarium.ui.widgets.StyledButton();
        expiredButton = new com.aldrin.ensarium.ui.widgets.StyledButton();
        returnedButton = new com.aldrin.ensarium.ui.widgets.StyledButton();
        shrinkageButton = new com.aldrin.ensarium.ui.widgets.StyledButton();
        ...
        refreshButton.setMargin(new java.awt.Insets(2, 2, 3, 2));
        refreshButton.setPreferredSize(new java.awt.Dimension(32, 32));
        jPanel3.add(refreshButton);

        addToOrderButton.setMargin(new java.awt.Insets(2, 2, 3, 2));
        addToOrderButton.setPreferredSize(new java.awt.Dimension(32, 32));
        jPanel3.add(addToOrderButton);

        stockOnHandReportButton.setMargin(new java.awt.Insets(2, 2, 3, 2));
        stockOnHandReportButton.setPreferredSize(new java.awt.Dimension(32, 32));
        jPanel3.add(stockOnHandReportButton);

        physicalCountReportButton.setMargin(new java.awt.Insets(2, 2, 3, 2));
        physicalCountReportButton.setPreferredSize(new java.awt.Dimension(32, 32));
        jPanel3.add(physicalCountReportButton);

        logsButton.setMargin(new java.awt.Insets(2, 2, 3, 2));
        logsButton.setPreferredSize(new java.awt.Dimension(32, 32));
        jPanel3.add(logsButton);

        damageButton.setMargin(new java.awt.Insets(2, 2, 3, 2));
        damageButton.setPreferredSize(new java.awt.Dimension(32, 32));
        jPanel3.add(damageButton);

        expiredButton.setMargin(new java.awt.Insets(2, 2, 3, 2));
        expiredButton.setPreferredSize(new java.awt.Dimension(32, 32));
        jPanel3.add(expiredButton);

        returnedButton.setMargin(new java.awt.Insets(2, 2, 3, 2));
        returnedButton.setPreferredSize(new java.awt.Dimension(32, 32));
        jPanel3.add(returnedButton);

        shrinkageButton.setMargin(new java.awt.Insets(2, 2, 3, 2));
        shrinkageButton.setPreferredSize(new java.awt.Dimension(32, 32));
        jPanel3.add(shrinkageButton);
        ...
        jPanel7.setPreferredSize(new java.awt.Dimension(10, 613));
        ...
        jPanel6.setPreferredSize(new java.awt.Dimension(10, 703));
    ...
    private com.aldrin.ensarium.ui.widgets.StyledButton addToOrderButton;
    private com.aldrin.ensarium.ui.widgets.StyledButton damageButton;
    private com.aldrin.ensarium.ui.widgets.StyledButton expiredButton;
    ...
    private com.aldrin.ensarium.ui.widgets.StyledButton logsButton;
    private com.aldrin.ensarium.ui.widgets.StyledButton physicalCountReportButton;
    private com.aldrin.ensarium.ui.widgets.StyledButton refreshButton;
    private com.aldrin.ensarium.ui.widgets.StyledButton returnedButton;
    private javax.swing.JTextField searchField;
    private com.aldrin.ensarium.ui.widgets.StyledButton shrinkageButton;
    private javax.swing.JLabel statusLabel;
    private com.aldrin.ensarium.ui.widgets.StyledButton stockOnHandReportButton;
...
//        table.getColumnModel().getColumn(9).setCellRenderer(new MoneyRenderer());
        ...
        table.getColumnModel().getColumn(11).setCellRenderer(new PercentRenderer());
        ...
        new SwingWorker<List<ProductInventoryItem>, Void>() {
            ...
            protected void done() {
                try {
                    ...
                    SwingUtils.showError(ProductInventoryPanel2.this, "Failed to load product inventory list.", ex instanceof Exception ? (Exception) ex : null);
                }
            }
        }.execute();
    }
